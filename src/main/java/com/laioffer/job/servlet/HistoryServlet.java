...
@WebServlet(name = "HistoryServlet", urlPatterns = {"/history"})//如果没有这个urlpattern就会出现404（server not found）;
public class HistoryServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //ObjectMapper mapper = new ObjectMapper();
        HistoryRequestBody body = mapper.readValue(request.getReader(), HistoryRequestBody.class);//这里是把要post的数据变成一个HistoryRequestBody的class;
